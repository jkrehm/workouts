define(['jquery', 'lodash', 'json!configuration.json', 'text!templates/exercise.html', 'plugins'],
function ($, _, cfg, tmplExercise) {

    'use strict';

    return function displayWorkouts(storage) {
        ...
        var poundage = storage.getItem('poundage') || {};
        var defaultWorkout = storage.getItem('default-workout');
        ...
        _.each(cfg.workouts, function (workout, index) {
            ...
            $tab.on('shown.bs.tab', function () {
                    storage.setItem('default-workout', workout.key);
                });
            ...
            _.each(workout.workouts, function (exercise) {
                ...
                $exercise.on('submit', function (e) {
                    ...
                    // Store values
                    poundage[poundageKey] = parseFloat(value);
                    storage.setItem('poundage', poundage);
